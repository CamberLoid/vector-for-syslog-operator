...
*/}}
{{- define "vector-for-syslog-operator.name" -}}
...
*/}}
{{- define "vector-for-syslog-operator.fullname" -}}
...
*/}}
{{- define "vector-for-syslog-operator.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "vector-for-syslog-operator.resourceName" -}}
{{- $fullname := include "vector-for-syslog-operator.fullname" .context }}
{{- $suffix := .suffix }}
